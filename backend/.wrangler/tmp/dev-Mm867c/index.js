...
// .wrangler/tmp/bundle-mDgkbc/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\madhu\\Desktop\\medium\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\madhu\\Desktop\\medium\\backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// .wrangler/tmp/bundle-mDgkbc/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-mDgkbc/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
init_modules_watch_stub();
var app = new Hono2();
var middleware = async (c, next) => {
  const Bearer_token = c.req.header("Authorization");
  if (Bearer_token === void 0) {
    c.status(401);
    return c.json({
...
// src/blog.ts
var blogRouter = new Hono2().basePath("/api/v1");
blogRouter.use("/blog/*", middleware);
blogRouter.post("/blog", (c) => {
  return c.json({
    message: "in the post blog"
  });
});
...
app2.route("/api/v1/book", blogRouter);
